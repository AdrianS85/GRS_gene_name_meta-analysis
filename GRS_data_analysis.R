...
sex_analysis$input <- list(
  'male' = merge(paper_number_male, exp_number_and_percentage_male, by = 'lower_final_gene_name'), 
  'female' = merge(paper_number_female, exp_number_and_percentage_female, by = 'lower_final_gene_name'))
...
sex_analysis$merge_all_f <- merge(x = sex_analysis$stable_direction_genes$male, y = sex_analysis$input$female, by = 'lower_final_gene_name', all.y = T)
