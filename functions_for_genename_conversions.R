...
make_and_write_table_with_original_and_ncbi_ids <- function(df_returned_by_entrez_gene_search, df_original_data, str_name_of_the_file = 'generic.tsv', experiment_directory_name = '.', str_to_cut_from_ncbi_response_to_form_back_Probe_ID)
{
  ...
  colnames(temp_df) <- c('external_gene_name', 'Probe_ID')
...
annotate_identifiers_to_geneID <- function(str_filename_, str_experiment_name, descriptions_, bool_reformat_names = F, chr_gene_identifier_ = 'Gene name', col_types__ = 'ncccccccccccccncc', int_numbers_are_from_ = 11, int_numbers_are_to_ = 13, str_substitute_inf_with_ = '15')
{
...
annotate_identifiers_to_geneID_wrapper_for_using_dfs_as_input <- function(descriptions__ = descriptions, df_to_annotate, str_experiment_name__ = '')
{
  ...
  annotated_other_ids_to_geneIDs <-
