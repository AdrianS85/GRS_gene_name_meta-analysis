...
search_for_ids_in_ncbi <- function(str_vector_of_ids, delay_between_queries = 0.8) ### !!! We should rename this variable, because this is actually query vector, and not id vector per se. Query vector includes id, but also includes organism (and other, perhaps?)
{
  ids <- list()
  counter <- 1
