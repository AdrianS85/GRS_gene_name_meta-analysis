...
prepare_input <- function(regex_, df_, col_everything = 'everything', col_put_resulting_identifiers_here = 'Probe_ID', col_order = 'Paper', regex_two_for_extracting_identifiers_from_string = '', col_get_resulting_identifer_from_here, vec_regex_additional_pattern_removal = '')
{
  search_vector <-
